...
const Home = () => {
  ...
  return (
    <div className="my-8 w-5/6 mx-auto">
      <div className=" h-[32rem] w-full  mx-auto relative ">
      <div className="w-full h-full absolute bg-gradient-to-b from-zinc-200 to-zinc-900 opacity-60"></div>
        ...
        <div className=" absolute z-20 bottom-10 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center h-1/3 justify-around ">
        <div className="">
          <h1 className="pb-6 text-white text-5xl font-semibold  ">
        ...
        <div className="bg-white rounded-sm mt-10 ">
