...
<button className="bg-black py-1.5 my-1 px-3 text-white" onClick={() => setRemoveHotelRoom(true)}>Remove</button>
{!removeHotelRoom ? ' ' :
   ...
   <p className='text-center text-lg pb-4'>remove Hote !!!!</p>
   <div className="flex gap-x-4">
   <button type='button' className='px-4 py-1.5 bg-slate-800 text-white '  onClick={()=> setRemoveHotelRoom(false)} >Cancel</button>
   <button type='button' className='px-4 py-1.5 bg-slate-800 text-white '  onClick={()=> removeRoom(ele.id  ) } >Remove</button>
   </div>
           </div> 
